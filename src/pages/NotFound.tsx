...
import { fadeInUp, scaleIn, staggerContainer } from '@/shared';
...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center">
      <motion.div
        className="w-full max-w-2xl px-8 py-12 text-center"
        variants={staggerContainer}
        initial="hidden"
        animate="visible"
      >
        <motion.div variants={scaleIn} className="w-24 h-24 mx-auto mb-8">
          <img
            src={xdriveLogo}
            alt="Xdrive"
