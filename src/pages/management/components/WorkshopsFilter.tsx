...
import { WorkshopQueryParams } from '@/interfaces';
import { useServices } from '@/queries/useServices';

interface WorkshopsFilterProps {
  currentFilters: WorkshopQueryParams;
  onApply: (filters: WorkshopQueryParams) => void;
  onClear: () => void;
}

export const WorkshopsFilter = ({
  currentFilters,
  onApply,
  onClear,
}: WorkshopsFilterProps) => {
  const [isOpen, setIsOpen] = useState(false);
  const [filters, setFilters] = useState<WorkshopQueryParams>(currentFilters);
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="workshop_name">Name</option>
                    <option value="average_rating">Rating</option>
                    <option value="no_of_mechanics">No. Mechanics</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
