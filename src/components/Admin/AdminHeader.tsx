        ...
        <div className="flex h-full items-center justify-between px-4 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 rounded-lg hover:bg-(--color-hover) transition-colors cursor-pointer"
            >
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 rounded-lg p-2 hover:bg-(--color-hover) transition-colors cursor-pointer"
              >
      ...
      >
        <div className="space-y-4">
          <p className="text-sm text-(--color-body)">
            ...
            login again to access the admin panel.
          </p>
